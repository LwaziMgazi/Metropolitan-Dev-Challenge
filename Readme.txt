...
3. Download the MetropolitanDevChallenge.zip folder to your computer.
4. first open the commad line in the serverside folder and command
      i.npm start: now the nodejs server will be running on http://localhost:5000
